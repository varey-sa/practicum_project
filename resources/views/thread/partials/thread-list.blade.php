    ...
    @forelse($threads as $thread)
        <div style="border: 1px solid #BDBBBB; padding: 10px; box-shadow: 2px 7px #DFD9D8;">
            ...
            <div class="thread-footer">
                <div class="pull-right">
                1300 views Posted by: <a href="{{route('user_profile',$thread->user->name)}}">{{$thread->user->name}}</a> at {{$thread->created_at->diffForHumans()}}
                </div>
                <div class="pull-left">
                    ...
                    <div class="modal-content">
                        <div class="modal-header" style="border: none">
                            ...
                            <div style="text-align: center">
                                <img src="https://pitcoder.github.io/img/portfolio/thumbnails/avatar.png" alt="Avatar" class="user-image-profile">
